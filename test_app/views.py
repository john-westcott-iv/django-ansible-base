...
################################################
# PROFILE STORIES — stub for merge conflict
# After rebasing on defer_rbac_computations, restore the full profiling
# endpoints here using RoleDefinition.bulk_give_permissions for the
# populate view's assignment phase.
################################################
